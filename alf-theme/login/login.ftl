...
<@layout.registrationLayout displayInfo=social.displayInfo; section>
    ...
    <#elseif section = "form">
        <div>
            <img class="logo" src="${url.resourcesPath}/img/mhh-logo.png" alt="Mhh">
        </div>
        <div class="box-container">
            <div>
                <p class="application-name">MHH Identity Service</p>
            </div>
        <#if realm.password>
            <div>
        ...
        <div>
            <p class="copyright">&copy; ${msg("${.now?string('yyyy')}")}</p>
        </div>
    </#if>
